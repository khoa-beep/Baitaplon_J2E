...
public class Sever_lucky {
    ...
    public static void lotteryInputValidator(DatagramSocket ds, List<Integer> winningNumbersList) throws IOException {
        ...
        while (true) {
            ...
            if (lotteryNumber != null) {
                resultSummary = getResultSummary(lotteryNumber, winningNumbersList);
            }
    ...
    private static String getResultSummary(String lotteryNumber, List<Integer> winningNumbersList) {
        if (lotteryNumber != null) {
            ...
            List<Integer> listCommon = winningNumbersList.stream().filter(e -> lottoValsfromClient.contains(e))
                    .collect(Collectors.toList()); // Stream operation to compare and find matching numbers

            StringBuilder sb = new StringBuilder();
            sb.append("The Winning Combination Numbers today were :" + winningNumbersList.toString());
            sb.append("\n");
